...
## - система предрасположенностей, которая сначала формируется у индивида под влияем социальной <span style="color:green;font-weight: 600;">среды, в которой он живет</span>, а затем регулирует поведение индивида без его сознательного участия.
