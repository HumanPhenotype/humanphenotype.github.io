...
<span style="color: #4CAF50;font-weight: 600;">методы формирования сознания личности – «убеждение»</span>: <span style="color:orange;font-weight: 600;">рассказ, объяснение, разъяснение, лекция, этическая беседа, увещевание, внушение, инструктаж, диспут, доклад, пример</span>; <br>
<span style="color: #4CAF50;font-weight: 600;">методы организации деятельности и формирования опыта поведения – «упражнение»</span>: <span style="color:orange;font-weight: 600;">упражнение, приучение, педагогическое требование, общественное мнение, поручение, воспитывающие ситуации</span>; <br>
<span style="color: #4CAF50;font-weight: 600;">методы стимулирования поведения и деятельности – «мотивация»</span>: <span style="color:orange;font-weight: 600;">соревнование, поощрение, наказание</span>.
