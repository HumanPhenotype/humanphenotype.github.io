...
## эмпирические методы – беседа, наблюдение, изучение документации и результатов деятельности, педагогический эксперимент (констатирующий, формирующий, контрольный), естественный эксперимент, социологические методы (социометрия, анкетирование и т.д.);
