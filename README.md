...
<center style="border:3.5px solid #068ef4;padding: 15px;border-radius: 7px;background:#068ef4;"><h2> >_ <span style="color:white;font-weight: 900;"> Подсознание - это в первую очередь </span> <span style="color:white;font-weight: 900;"> { рептильный мозг и лимбическая система: ЭМОЦИИ, ОБРАЗЫ, ВКУС, ЗВУК, ЗАПАХИ и ОЩУЩЕНИЯ } </span></h2></center>
