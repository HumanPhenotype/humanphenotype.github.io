...
- <span style="color:orange;">3.55</span> <span style="color:violet;font-weight: 600;">управление:</span> Деятельность, направленная на заданное изменение состояния чего-либо (например, объекта, системы).
