...
<center><h2> >_ <span style="color:white;font-weight: 900;"> Подсознание - это в первую очередь </span> <span style="color:white;font-weight: 900;"> { <span style="color:white;font-weight: 900;">рептильный мозг</span> и <span style="color:white;font-weight: 900;">лимбическая система</span>: ЭМОЦИИ, ОБРАЗЫ, ВКУС, ЗВУК, ЗАПАХИ и ОЩУЩЕНИЯ } </span></h2></center>
